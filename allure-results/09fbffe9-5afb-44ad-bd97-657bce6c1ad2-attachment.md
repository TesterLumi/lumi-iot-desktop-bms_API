...
- Name: e2e\automation-scenes\ui-evidence.spec.ts >> Scene UI Evidence Real HC TC1-TC6 >> TC1 - Tao scene thuy<N> add device online thật
- Location: tests\e2e\automation-scenes\ui-evidence.spec.ts:64:3
