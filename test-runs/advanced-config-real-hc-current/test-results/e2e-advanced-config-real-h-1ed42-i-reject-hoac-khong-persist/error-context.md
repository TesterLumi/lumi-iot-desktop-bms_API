...
- Name: e2e\advanced-config-real-hc\advanced-config-real-hc.spec.ts >> Advanced config real HC >> TC-AC-028 - Presence auto_calib gui sai qua config bi reject hoac khong persist
...
Call log:
  - → GET http://10.10.30.154:8080/api/devices/120416080507841536/config
    - user-agent: Playwright/1.60.0 (x64; windows 10.0) node/24.16
    - accept: */*
    - accept-encoding: gzip,deflate,br
    - x-hc-id: 4932308540097724437
    - x-request-id: advanced-config-1785903091712
