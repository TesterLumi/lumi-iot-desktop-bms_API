...
- Name: e2e\advanced-config-real-hc\advanced-config-real-hc.spec.ts >> Advanced config real HC >> TC-AC-030 - Presence distance ngoai range bi reject hoac khong persist
