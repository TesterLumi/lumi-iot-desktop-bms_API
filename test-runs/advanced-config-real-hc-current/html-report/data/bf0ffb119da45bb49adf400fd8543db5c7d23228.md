...
- Name: e2e\advanced-config-real-hc\advanced-config-real-hc.spec.ts >> Advanced config real HC >> TC-AC-026 - Presence event active delete bang null
...
Call log:
  - → GET http://10.10.30.154:8080/api/devices/120416080507841536/config
    ...
    - x-request-id: advanced-config-1785903055991
