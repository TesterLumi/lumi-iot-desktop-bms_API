...
- Name: e2e\advanced-config-real-hc\advanced-config-real-hc.spec.ts >> Advanced config real HC >> TC-AC-015 - MSB clear_power gui sai qua config bi reject hoac khong persist
