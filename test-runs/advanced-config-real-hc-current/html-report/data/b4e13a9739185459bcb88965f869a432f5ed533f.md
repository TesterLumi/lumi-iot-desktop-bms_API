...
- Name: e2e\advanced-config-real-hc\advanced-config-real-hc.spec.ts >> Advanced config real HC >> TC-AC-056 - Presence presence_mode ngoai enum bi reject hoac khong persist
